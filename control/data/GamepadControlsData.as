package volticpunk.control.data {
	 ...
	 * @author zeh fernando
	 */
	public class GamepadControlsData {

        [Embed(source="controllers.json", mimeType='application/octet-stream')]
        private static const JSON_CONTROLLERS:Class;

        private static var jsonControllerData: Object = null;

        public static function getControllerData(): Object {

            if (jsonControllerData == null) {
                jsonControllerData = JSON.parse(String(new JSON_CONTROLLERS()).replace(/\/\*.*?\*\//sg, ""));;
            }

            return jsonControllerData;
        }
